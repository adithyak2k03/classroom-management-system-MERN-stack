...
const sampleNotes = [
    { title: "Frontend Development", description: "Complete the React component for the new user dashboard.", tag: "Development" },
    { title: "Backend API Integration", description: "Implement API routes for user authentication and authorization.", tag: "Development" },
    { title: "ML Model Training", description: "Fine-tune the neural network for image classification task.", tag: "AI/ML" },
    { title: "Code Review", description: "Review the PR for the new feature in the MERN stack app.", tag: "Development" },
    { title: "Deployment Pipeline", description: "Set up continuous integration for automated testing and deployment.", tag: "DevOps" },
    { title: "AI/ML Research", description: "Read recent research papers on GANs and their applications.", tag: "Research" },
];
...
const populateData = async () => {
    if (!token || !userId) {
        console.error("Token or User ID not provided. Please add them to the script.");
        return;
    }
